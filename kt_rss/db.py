...
def connect(db_path: str) -> sqlite3.Connection:
    ...
    check_same_thread=False: FastAPI:s generator-dependency get_conn_settings
    kör setup och cleanup (conn.close()) i skilda trådar ur threadpoolen, och
    sqlite3 kastar annars ProgrammingError. Varje anslutning används bara
    sekventiellt av en request eller pollrunda, aldrig samtidigt från två
    trådar, så det är säkert.
    """
